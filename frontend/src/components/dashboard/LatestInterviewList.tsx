...
export default function LatestInterviewList() {
  ...
  return (
    <div className="my-6">
      <div className="mb-5 rounded-[32px] border border-slate-200 bg-slate-50 p-5 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h2 className="text-2xl font-bold text-slate-900">Previously Created Interviews</h2>
            <p className="mt-1 text-sm text-slate-600">Saved interviews appear here for quick review, sharing, and scheduling.</p>
          </div>
          <div className="grid w-full gap-3 sm:w-auto sm:grid-cols-3">
            {[
              ...
              <div key={stat.label} className="rounded-3xl bg-white p-4 text-center shadow-sm">
