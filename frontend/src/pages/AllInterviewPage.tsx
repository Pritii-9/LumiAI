  ...
  return (
    <div className="my-5">
      <div className="mb-5 flex flex-col gap-4 rounded-[32px] border border-slate-200 bg-slate-50 p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-slate-900">All Previously Created Interviews</h2>
          <p className="mt-1 text-sm text-slate-600">Browse all saved interviews and manage candidate-ready sessions from one place.</p>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          <span className="rounded-full bg-white px-4 py-2 text-sm text-slate-700 shadow-sm">Total: {stats.totalInterviews}</span>
